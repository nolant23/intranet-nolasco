...
import { getInterventiPaginated, getImpianti, getTecnici } from "./actions";
...
const InterventiClient = dynamic(
  () => import("./components/InterventiClient").then((m) => m.InterventiClient),
...
export default async function InterventiPage() {
  ...
  if (currentUser.role === "TECNICO") redirect("/tecnici/servizi/interventi");
